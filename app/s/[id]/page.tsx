...
export default function SharedParlayPage() {
  ...
  return (
    <div className="max-w-[500px] mx-auto px-4 py-16 text-center">
      <div className="bg-surface-2 border border-border-default rounded-card p-8">
        ...
        <div className="bg-surface-3 border border-border-default rounded-button p-3 mb-6">
        ...
        <div className="space-y-2 mb-6 text-left">
          <div className="flex items-center gap-2 p-3 bg-surface-3 rounded-button border border-border-default">
