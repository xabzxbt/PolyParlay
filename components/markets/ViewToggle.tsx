  ...
  return (
    ...
    >
      <button
        ...
        style={{
          backgroundColor: value === "grouped" ? 'var(--accent-mocha)' : 'transparent',
          color: value === "grouped" ? 'var(--text-inverse)' : 'var(--text-muted)',
        }}
      >
      ...
      <button
        ...
        className="flex items-center gap-1 px-2.5 py-1.5 rounded-md text-[10px] font-semibold transition-all"
        style={{
          backgroundColor: value === "flat" ? 'var(--accent-mocha)' : 'transparent',
          color: value === "flat" ? 'var(--text-inverse)' : 'var(--text-muted)',
        }}
      >
        <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
